    ...
    components: [
      ...
      },
      {
        ...
        content: {
          ...
          badges: [
            { label: '7-day free trial', color: 'green' },
            { label: 'No commitment', color: 'blue' },
            { label: 'Expert trainers', color: 'orange' }
          ]
        },
        design: {
    ...
    components: [
      ...
      },
      {
        ...
        content: {
          ...
          badges: [
            { label: 'Top 1% of agents', color: 'gold' },
            { label: 'Average 14 days to sell', color: 'green' },
            { label: '98% client satisfaction', color: 'blue' }
          ]
        },
        design: {
  ...
  },
  {
    ...
    components: [
      ...
      },
      {
        ...
        design: {
          theme: 'elegant', layout: 'centered', backgroundColor: 'bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900', textColor: 'text-white',
          typography: undefined,
          colors: undefined,
          shadows: undefined,
          borders: undefined,
